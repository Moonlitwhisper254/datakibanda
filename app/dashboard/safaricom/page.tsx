...
export default function SafaricomPage() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/images/safaricom-watermark.png')",
    ...
    >
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-green-600">Safaricom Bundles</h1>
        <p className="text-muted-foreground">Choose from a variety of Safaricom data bundles</p>
      </div>
              ...
              >
                ...
                <CardContent>
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-2xl font-bold text-green-600">{pkg.data}</p>
